...
export default function PartnerForm() {
  return (
    <div className="w-full min-h-screen bg-[#04413D]/20 flex  justify-center mx-auto py-10 px-4">
            ...
            <Form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex justify-center mt-6">
                <button
                  ...
                  className="px-8 py-3 bg-[#04413D] text-white font-semibold rounded-lg hover:bg-[#03312e] focus:outline-none focus:ring-2 focus:ring-[#04413D] focus:ring-offset-2 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed min-w-[70vh]"
                >
                  {isSubmitting ? (
